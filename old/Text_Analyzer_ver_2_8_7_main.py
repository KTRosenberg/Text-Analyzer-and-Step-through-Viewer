...
def word_step(all_text, new_line_positions, word_count, starting_line, choice='>'):
    ...
    if starting_line > 1 and choice == __W_NEXT_INST:
        ...
        found = binary_min_line_above_search(line_numbers, starting_line, len(line_numbers) - 1, starting_line)
        ...
        found = binary_max_line_below_search(line_numbers, 0, starting_line, starting_line)
                    ...
                    try:
                        ...
                        if step == __W_NEXT_INST or step == __W_PREV_INST:
                            ...
                            try:
                                ...
                                print("EXCEPTION IN FUNCTION WORD_STEP")
                            ##########
