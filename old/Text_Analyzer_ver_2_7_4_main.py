...
def word_step(all_text, new_line_positions, word_count):
    ...
    while w_instance < num_word_inst:
        ...
        choice = input("l" + str(current_line) + " number of words between instances of : " + str(num_words_between[w_instance]) + " >> ")
            ...
            if cur_step < step:
                ...
                while True:
                    try:
                        ...
                        cur_step = 0
                        if step == '>':
                            step = word_step(all_text, new_line_positions, word_count)
                        else:
                            step = int(step)
                        if step > 0:
                            pos += 1
